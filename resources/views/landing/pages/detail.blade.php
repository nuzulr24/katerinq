        ...
        <div class="col-lg-12">
            @if(!empty($pages->is_thumbnail))
                <div class="w-100 mb-3">
                    <img src="{{ assets_url($pages->is_thumbnail) }}" alt="Image"/>
                </div>
            @endif

            <div class="portfolio-description">
              <h6 class="h3 mb-3 font-weight-bold">{{ $pages->title }}</h6>
              <div class="fs-sm pe-3 me-3">Dibuat pada {{ date_formatting($pages->is_created, 'timeago') }}</div>
