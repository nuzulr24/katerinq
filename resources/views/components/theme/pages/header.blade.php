        ...
        <div id="kt_app_header" class="app-header " data-kt-sticky="true"
            ...
            <div class="app-container  container-fluid d-flex flex-stack " id="kt_app_header_container">
                ...
                <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
                    ...
                    <!--begin::Logo image-->
                    <a href="{{ url('/') }}">
                        <img alt="Logo" src="{{ assets_url(app_info('logo')) }}"
                ...
                <div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
                    ...
                    @if(segment(1) === "user")
                        ...
                        @yield('additional')
                            <a href="{{ site_url('user', 'account/cart') }}" class="me-2 btn btn-outline btn-outline-dashed btn-outline-primary btn-active-light-primary justify-content-end">
                                <i class="ki-outline ki-purchase fs-3 me-n1"></i>
                                <span class="mb-0">Keranjang</span>
                            </a>
                        </div>
                    @elseif(segment(1) === "seller")
                        <div class="d-flex ms-auto">
                        @yield('additional')
                        </div>
                    @else
                    ...
                    @if(!empty($data['button']))
                        ...
                        @php
                            $url = $data['module']['url'];
                        @endphp
                        <a href="{{ $data['module']['url'] }}" class="btn btn-primary d-flex flex-center h-35px h-lg-40px">
        ...
        <div class="app-wrapper flex-column flex-row-fluid " id="kt_app_wrapper">
            ...
            <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                ...
                @if(auth()->user()->level != enum('isAdmin'))
                    <div class="app-sidebar-header d-lg-flex px-6 pt-8 pb-4 page-feature" id="kt_app_sidebar_header">
                ...
                <div class="app-sidebar-footer d-flex flex-stack px-11 pb-10 page-setting" id="kt_app_sidebar_footer">
                    <!--begin::User menu-->
                    <div class="">
                        <!--begin::Menu wrapper-->
