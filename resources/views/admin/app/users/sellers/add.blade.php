...
<section>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{ Form::open(['route' => 'users.sellers.store']) }}
                    @csrf
                        <div class="row mb-4">
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" autocomplete="off" class="form-control form-control-solid mt-2 {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="Masukkan Nama Toko">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input class="form-control form-control-solid mt-2 {{ $errors->has('alias') ? 'is-invalid' : '' }}" type="text" name="alias" placeholder="cth: s.mhdrizqy">
