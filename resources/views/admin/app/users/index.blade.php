                ...
                render: function (data, type, row) {
                    return `
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ app_url('users/detail') }}/${row.id}" class="menu-link px-3 viewContent">
                                    Detail
                                </a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ app_url('users/edit') }}/${row.id}" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                    Edit
                                </a>
                            </div>
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" data-url="{{ app_url('users/delete') }}/${row.id}" class="menu-link px-3 deleteContent">
                                    Delete
                                </a>
                            </div>
                            <!--end::Menu item-->
