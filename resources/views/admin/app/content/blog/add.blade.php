...
<div class="row">
    <form action="{{ route('content.store') }}" method="POST" enctype="multipart/form-data" class="row">
    @csrf
        <div class="col-md-8">
            <div class="form-group">
                <input type="text" name="title" class="form-control mt-1 mb-4 content-title" value="{{ old('title') }}" placeholder="Your title anything">
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-3">
                        <label for="exampleEmail1" class="mb-2">{{ __('page.content.add_new.category') }}</label>
                        <select class="form-control form-select form-select-solid mt-1" name="is_category">
                            <option value="">{{ __('page.content.add_new.category_option') }}</option>
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleEmail1" class="mb-3">{{ __('page.content.add_new.tag') }}</label>
                        <select class="form-control form-select form-select-solid mt-1 input-tag" multiple="multiple" name="is_tags[]">
