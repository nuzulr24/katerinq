                    ...
                    return `
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ app_url('content/p') }}/${row.id}" class="menu-link px-3">
                                    Detail
                                </a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ app_url('content/edit') }}/${row.id}" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                    Edit
                                </a>
                            </div>
                            
                            <div class="menu-item px-3">
                                <a href="#" data-url="{{ app_url('content/delete') }}/${row.id}" class="menu-link px-3 deleteContent" data-kt-docs-table-filter="delete_row">
                                    Delete
                                </a>
                            </div>
                        </div>
